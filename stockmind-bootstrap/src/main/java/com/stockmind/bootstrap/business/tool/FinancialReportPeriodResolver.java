...
public final class FinancialReportPeriodResolver {
    ...
    public static Optional<ResolvedPeriod> resolve(String value) {
    ...
    public static Optional<ResolvedPeriod> findInText(String text) {
    ...
    public record ResolvedPeriod(String reportPeriod, String reportType) {}
}
