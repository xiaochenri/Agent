...
public class FinancialMetricTools extends StockToolSupport {
    ...
    @AgentTool(
            ...
            description = "使用财报披露EPS，或按归母净利润/股本计算EPS，再按股价/EPS计算PE；输入缺失时明确失败。")
    public String calculate(Map<String, Object> input, String raw) {
        ...
        data.put("pe_basis", firstNonBlank(asString(input.get("pe_basis")), "static_at_price_date"));
